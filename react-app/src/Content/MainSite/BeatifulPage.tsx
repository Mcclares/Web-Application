...
//             <Card className="mt-4">
//               <Card.Body style={{ textAlign: 'left', color: '#333' }}>
//                 <Card.Title style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#007bff' }}>{t('about_us_title')}</Card.Title>
//                 <Card.Text style={{ fontSize: '1.1rem', lineHeight: '1.7' }}>
//                   <ul style={{ listStyleType: 'none', padding: 0 }}>
//                     <li style={{ marginBottom: '10px' }}><FaCheckCircle style={{ color: '#666666', marginRight: '10px' }} />{t('about_us_list1')}</li>
//                     <li style={{ marginBottom: '10px' }}><FaCheckCircle style={{ color: '#007bff', marginRight: '10px' }} />{t('about_us_list2')}</li>
//                     <li style={{ marginBottom: '10px' }}><FaCheckCircle style={{ color: '#007bff', marginRight: '10px' }} />{t('about_us_list3')}</li>
//                     <li style={{ marginBottom: '10px' }}><FaCheckCircle style={{ color: '#007bff', marginRight: '10px' }} />{t('about_us_list4')}</li>
//                     <li style={{ marginBottom: '10px' }}><FaCheckCircle style={{ color: '#007bff', marginRight: '10px' }} />{t('about_us_list5')}</li>
//                     <li style={{ marginBottom: '10px' }}><FaCheckCircle style={{ color: '#007bff', marginRight: '10px' }} />{t('about_us_list6')}</li>
//                   </ul>
//                   <p style={{ color: '#007bff', fontWeight: 'bold' }}>{t('about_us_conclusion')}</p>
//                 </Card.Text>
//               </Card.Body>
//             </Card>
//           </Col>
